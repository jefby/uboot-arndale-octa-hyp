...
/* CLK_SRC_CAM */
#define CAM_SEL_XUSBXTI		1
#define CAM_SEL_SCLKMPLL	6

#define CAM0_SEL		CAM_SEL_XUSBXTI
#define FIMC0_LCLK_SEL		CAM_SEL_SCLKMPLL
#define FIMC1_LCLK_SEL		CAM_SEL_SCLKMPLL
#define FIMC2_LCLK_SEL		CAM_SEL_SCLKMPLL
#define FIMC3_LCLK_SEL		CAM_SEL_SCLKMPLL

#define CLK_SRC_CAM_VAL		((CAM0_SEL << 16) \
				| (FIMC3_LCLK_SEL << 12) \
				| (FIMC2_LCLK_SEL << 8) \
				| (FIMC1_LCLK_SEL << 4) \
				| (FIMC0_LCLK_SEL << 0))
